...
export default class MonthlyGoals extends React.Component {
    ...
    render() {
        return (
            <div className="Monthly_Goals">
                <button className='collapsible' onClick={() => this.toggleCollapsed()}> <h2>Monthly Goals</h2> </button>
                {this.buildList()}
            </div>
        )
    }
